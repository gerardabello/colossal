...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactTapEventPlugin = __webpack_require__(1);
	...
	ReactDom.render(React.createElement(_app2.default, null), document.getElementById('react-root'));

/***/ },
/* 1 */
/***/ function(module, exports, __webpack_require__) {

	var defaultClickRejectionStrategy = __webpack_require__(2);

	module.exports = function injectTapEventPlugin (strategyOverrides) {
	  strategyOverrides = strategyOverrides || {}
	  var shouldRejectClick = strategyOverrides.shouldRejectClick || defaultClickRejectionStrategy;

	  __webpack_require__(3).injection.injectEventPluginsByName({
	    "TapEventPlugin":       __webpack_require__(15)(shouldRejectClick)
	  });
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventPluginRegistry = __webpack_require__(5);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventConstants = __webpack_require__(8);
	var EventPluginHub = __webpack_require__(3);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getEventTarget = __webpack_require__(21);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _monoSynth = __webpack_require__(30);

	var _monoSynth2 = _interopRequireDefault(_monoSynth);

	var _polySynth = __webpack_require__(170);
	...
	var App = React.createClass({
		...
		componentDidMount: function componentDidMount() {
			...
			var dstGainNode = audioCtx.createGain();
		...
		render: function render() {
			return React.createElement(
				'div',
				null,
				React.createElement(_polySynth2.default, { ctx: this.state.ctx, dstNode: this.state.dstNode })
			);
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _maps = __webpack_require__(169);
	...
	var MonoSynth = _react2.default.createClass({
	    ...
	    componentWillReceiveProps: function componentWillReceiveProps(nextProps) {
	        if (this.props.ctx != nextProps.ctx) {
	            var osc = nextProps.ctx.createOscillator();
	    ...
	    //HANDLERS
	    handleChangePitch: function handleChangePitch(e) {
	        var val = e.target.value;
	        var tval = _maps2.default.tolog(val, e.target.min, e.target.max);
	    ...
	    render: function render() {
	        return _react2.default.createElement(
	            'div',
	            { style: styles.root },
	            _react2.default.createElement('input', { type: 'range', min: '20', max: '22000', value: this.state.frequency, step: '1', onChange: this.handleChangePitch })
	        );
	    }
	});
...
/***/ function(module, exports) {
	...
	var Maps = {
	    tolog: function tolog(val, min, max) {
	        var exp = (val - min) / (min - max);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _voice = __webpack_require__(171);
	...
	var PolySynth = _react2.default.createClass({
	    ...
	    componentWillReceiveProps: function componentWillReceiveProps(nextProps) {},
	    //HANDLERS
	    handleMouseDown: function handleMouseDown(note) {
	        var v = new _voice2.default(this.props.ctx, this.props.dstNode, 440, 0.012, 1, 0.001, 1, 1);
	        var n = this.state.notes;
	        n[note] = v;
	        this.setState({ notes: n });
	    },
	    handleMouseUp: function handleMouseUp(note) {
	    ...
	    render: function render() {
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                'button',
	                { type: 'button', onMouseDown: this.handleMouseDown.bind(this, "A4"), onMouseUp: this.handleMouseUp.bind(this, "A4") },
	                'Click Me!'
	            )
	        );
	    }
...
/***/ function(module, exports) {
	...
	var Voice = function () {
	    function Voice(ctx, dst, freq, attackTime, maxGain, sustainTime, sustainGain, decayTime) {
